...
#include <iomanip>
#include <fstream>
#include "System_Half.h"

/*
g++ TB_Half.cpp -I$HOME/systemc-3.0.2/install/include -L$HOME/systemc-3.0.2/install/lib \
    -Wl,-rpath,$HOME/systemc-3.0.2/install/lib -lsystemc -o half_sim

./half_sim > result_half.txt
*/
