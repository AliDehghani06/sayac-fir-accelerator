...
SC_MODULE(DMA)
{
    ...
    sc_fifo_out<sc_lv<16>> firDataIn;  // DMA pushes samples INTO FIR's input FIFO  (mem -> FIR)
    sc_fifo_in<sc_lv<16>> firDataOut;  // DMA pulls filtered samples FROM FIR's output FIFO (FIR -> mem)
