...
#include <iomanip>
#include <fstream>
#include "System_Filter_Channel.h"

/*
g++ TB_Filter_Channel.cpp busChannel.cpp Transactor.cpp SlaveTransactor.cpp \
    -I$HOME/systemc-3.0.2/install/include \
    -L$HOME/systemc-3.0.2/install/lib \
    -Wl,-rpath,$HOME/systemc-3.0.2/install/lib \
    -lsystemc \
    -o filter_channel_sim

./filter_channel_sim > result_filter_channel.txt
*/
